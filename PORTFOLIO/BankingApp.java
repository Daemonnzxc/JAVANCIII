...
public class BankingApp {
    private static User[] users = {
        new User(1111, 1111, "Dave Tan", 1_000_000),
        new User(1234, 1234, "Son Goku", 5_0000_000),
        new User(3333, 3333, "Jhony Sins", 3_000_000),
    };
    ...
    private static void checkBalance() {
        ...
        if (loggedInUser.getBalance() < 0) {
            System.out.println("Error: Insufficient balance. Please contact support.");
    ...
    private static void Deposit() {
        ...
        while (true) {
            ...
            if (amount <= 0) {
                ...
                break;  // Exit loop after a successful Deposit
            }
        }
